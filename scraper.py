...
# --- 1. PORTAL NGO.PL (GŁĘBOKIE SKRAPOWANIE LINKÓW DO KAŻDEGO OGŁOSZENIA) ---
...
# --- 2. PORTALE AGREGUJĄCE (BEZPOŚREDNIE LINKI DO WYSZUKIWAREK I ZAKŁADEK Z NABORAMI) ---
...
# --- 3. REGION DOLNY ŚLĄSK & KARKONOSZE (BEZPOŚREDNIE LINKI DO ZAKŁADEK NGO / BIP / GENERATORÓW) ---
...
def pobierz_dolnoslaskie_male_granty(g_id):
    return [{
        ...
        "url": "https://www.dolnoslaskiemalegranty.pl/zloz-wniosek/"
    }], g_id + 1
...
def pobierz_lgd_ducha_gor(g_id):
    return [{
        ...
        "url": "https://www.duchagor.pl/pl/artykuly/nabory-wnioskow-i-konkursy"
    }], g_id + 1
...
def pobierz_fed_dolny_slask(g_id):
    return [{
        ...
        "url": "https://www.funduszeuedolnyslask.pl/nabory"
    }], g_id + 1
...
def pobierz_umwd(g_id):
    return [{
        ...
        "url": "https://umwd.dolnyslask.pl/organizacje-pozarzadowe/otwarte-konkursy-ofert/"
    }], g_id + 1
...
def pobierz_dfop(g_id):
    return [{
        ...
        "url": "https://dfop.org.pl/category/aktualnosci/"
    }], g_id + 1
...
def pobierz_jelenia_gora_ngo(g_id):
    return [{
        ...
        "url": "https://bip.jeleniagora.pl/menu/216/wspolpraca-z-ngo"
    }], g_id + 1
...
def pobierz_powiat_karkonoski(g_id):
    return [{
        ...
        "url": "https://powiatkarkonoski.pl/organizacje-pozarzadowe"
    }], g_id + 1


# --- 4. PROCES URUCHOMIENIA ---

print("🚀 Generowanie bazy z precyzyjnymi, głębokimi adresami URL...")
wszystkie_granty = []
aktualne_id = 1
...
print(f"✅ Sukces! Zapisano {len(wszystkie_granty)} rekordów z głębokimi linkami.")
